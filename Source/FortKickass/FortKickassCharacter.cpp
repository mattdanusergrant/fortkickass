...
//////////////////////////////////////////////////////////////////////////
// AFortKickassCharacter

AFortKickassCharacter::AFortKickassCharacter()
{
...
void AFortKickassCharacter::NotifyControllerChanged()
{
...
void AFortKickassCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AFortKickassCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AFortKickassCharacter::Look);
	}
	else
	{
...
void AFortKickassCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AFortKickassCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
